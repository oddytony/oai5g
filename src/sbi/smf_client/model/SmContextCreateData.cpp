...
web::json::value SmContextCreateData::toJson() const
{
    ...
    {
        val[utility::conversions::to_string_t("requestType")] = ModelBase::toJson(m_RequestType);
    }
    if(m_N1SmMsgIsSet)
    {
    ...
    {
        val[utility::conversions::to_string_t("secondAnType")] = ModelBase::toJson(m_SecondAnType);
    }
    if(m_RatTypeIsSet)
    {
    ...
    {
        val[utility::conversions::to_string_t("presenceInLadn")] = ModelBase::toJson(m_PresenceInLadn);
    }
    ...
    }
    {
        ...
        if(jsonArray.size() > 0)
        {
            val[utility::conversions::to_string_t("additionalHsmfUri")] = web::json::value::array(jsonArray);
        }
    }
    if(m_OldPduSessionIdIsSet)
    {
        val[utility::conversions::to_string_t("oldPduSessionId")] = ModelBase::toJson(m_OldPduSessionId);
    }
    {
        std::vector<web::json::value> jsonArray;
        ...
        if(jsonArray.size() > 0)
        {
            val[utility::conversions::to_string_t("pduSessionsActivateList")] = web::json::value::array(jsonArray);
        }
    }
    ...
    if(m_NrfUriIsSet)
    {
        val[utility::conversions::to_string_t("nrfUri")] = ModelBase::toJson(m_NrfUri);
    }
    ...
    }
    {
        ...
        if(jsonArray.size() > 0)
        {
            val[utility::conversions::to_string_t("backupAmfInfo")] = web::json::value::array(jsonArray);
        }
    }
    if(m_TraceDataIsSet)
    {
    ...
    {
        val[utility::conversions::to_string_t("indirectForwardingFlag")] = ModelBase::toJson(m_IndirectForwardingFlag);
    }
    if(m_TargetIdIsSet)
    {
    ...
    {
        val[utility::conversions::to_string_t("epsBearerCtxStatus")] = ModelBase::toJson(m_EpsBearerCtxStatus);
    }
    if(m_CpCiotEnabledIsSet)
    {
        val[utility::conversions::to_string_t("cpCiotEnabled")] = ModelBase::toJson(m_CpCiotEnabled);
    }
    if(m_InvokeNefIsSet)
    {
        val[utility::conversions::to_string_t("invokeNef")] = ModelBase::toJson(m_InvokeNef);
    }
    if(m_MaPduIndicationIsSet)
    {
        val[utility::conversions::to_string_t("maPduIndication")] = ModelBase::toJson(m_MaPduIndication);
    }
    if(m_N2SmInfoIsSet)
    {
    ...
    {
        val[utility::conversions::to_string_t("smContextRef")] = ModelBase::toJson(m_SmContextRef);
    }
...
void SmContextCreateData::fromJson(const web::json::value& val)
{
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("requestType"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("secondAnType"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("presenceInLadn"));
        if(!fieldValue.is_null())
        {
    ...
    }
    {
        ...
        {
        for( auto& item : val.at(utility::conversions::to_string_t("additionalHsmfUri")).as_array() )
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("oldPduSessionId"));
        if(!fieldValue.is_null())
        {
    ...
    }
    {
        ...
        std::vector<web::json::value> jsonArray;
        if(val.has_field(utility::conversions::to_string_t("pduSessionsActivateList")))
        {
        for( auto& item : val.at(utility::conversions::to_string_t("pduSessionsActivateList")).as_array() )
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("ueEpsPdnConnection"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("nrfUri"));
        if(!fieldValue.is_null())
        {
    ...
    }
    {
        ...
        {
        for( auto& item : val.at(utility::conversions::to_string_t("backupAmfInfo")).as_array() )
        {
            if(item.is_null())
            {
    ...
    if(val.has_field(utility::conversions::to_string_t("indirectForwardingFlag")))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("indirectForwardingFlag"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("epsBearerCtxStatus"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("cpCiotEnabled"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("invokeNef"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("maPduIndication"));
        if(!fieldValue.is_null())
        {
    ...
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t("smContextRef"));
        if(!fieldValue.is_null())
        {
...
void SmContextCreateData::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t("."))
    {
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("requestType")))
    {
        ...
        {
            std::shared_ptr<RequestType> newItem(new RequestType());
            newItem->fromMultiPart(multipart, utility::conversions::to_string_t("requestType."));
            setRequestType( newItem );
        }
    }
    ...
    setAnType( newAnType );
    if(multipart->hasContent(utility::conversions::to_string_t("secondAnType")))
    {
        if(multipart->hasContent(utility::conversions::to_string_t("secondAnType")))
        {
            std::shared_ptr<AccessType> newItem(new AccessType());
            newItem->fromMultiPart(multipart, utility::conversions::to_string_t("secondAnType."));
            setSecondAnType( newItem );
        }
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("presenceInLadn")))
    {
        if(multipart->hasContent(utility::conversions::to_string_t("presenceInLadn")))
        {
            std::shared_ptr<PresenceState> newItem(new PresenceState());
            newItem->fromMultiPart(multipart, utility::conversions::to_string_t("presenceInLadn."));
            setPresenceInLadn( newItem );
        }
    }
    ...
    {
        m_AdditionalHsmfUri.clear();
        if(multipart->hasContent(utility::conversions::to_string_t("additionalHsmfUri")))
        {

        web::json::value jsonArray = web::json::value::parse(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("additionalHsmfUri"))));
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("oldPduSessionId")))
    {
        setOldPduSessionId(ModelBase::int32_tFromHttpContent(multipart->getContent(utility::conversions::to_string_t("oldPduSessionId"))));
    }
    {
        m_PduSessionsActivateList.clear();
        if(multipart->hasContent(utility::conversions::to_string_t("pduSessionsActivateList")))
        {

        web::json::value jsonArray = web::json::value::parse(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("pduSessionsActivateList"))));
        for( auto& item : jsonArray.as_array() )
        {
            m_PduSessionsActivateList.push_back(ModelBase::int32_tFromJson(item));
        }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("ueEpsPdnConnection")))
    {
    ...
    {
        setNrfUri(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("nrfUri"))));
    }
    ...
    {
        m_BackupAmfInfo.clear();
        if(multipart->hasContent(utility::conversions::to_string_t("backupAmfInfo")))
        {

        web::json::value jsonArray = web::json::value::parse(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("backupAmfInfo"))));
        for( auto& item : jsonArray.as_array() )
        {
            if(item.is_null())
            {
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("indirectForwardingFlag")))
    {
        setIndirectForwardingFlag(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("indirectForwardingFlag"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("targetId")))
    {
        ...
        {
            std::shared_ptr<NgRanTargetId> newItem(new NgRanTargetId());
            newItem->fromMultiPart(multipart, utility::conversions::to_string_t("targetId."));
            setTargetId( newItem );
        }
    }
    if(multipart->hasContent(utility::conversions::to_string_t("epsBearerCtxStatus")))
    {
        setEpsBearerCtxStatus(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("epsBearerCtxStatus"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("cpCiotEnabled")))
    {
        setCpCiotEnabled(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("cpCiotEnabled"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("invokeNef")))
    {
        setInvokeNef(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("invokeNef"))));
    }
    if(multipart->hasContent(utility::conversions::to_string_t("maPduIndication")))
    {
        setMaPduIndication(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("maPduIndication"))));
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("smContextRef")))
    {
        setSmContextRef(ModelBase::stringFromHttpContent(multipart->getContent(utility::conversions::to_string_t("smContextRef"))));
    }
}
...
void SmContextCreateData::setServiceName(const std::shared_ptr<ServiceName>& value)
{
    m_ServiceName = value;
...
void SmContextCreateData::setServingNetwork(const std::shared_ptr<PlmnId>& value)
{
...
void SmContextCreateData::setRequestType(const std::shared_ptr<RequestType>& value)
{
    m_RequestType = value;
...
void SmContextCreateData::setN1SmMsg(const std::shared_ptr<RefToBinaryData>& value)
{
    m_N1SmMsg = value;
    m_N1SmMsgIsSet = true;
}
...
void SmContextCreateData::setSecondAnType(const std::shared_ptr<AccessType>& value)
{
...
void SmContextCreateData::setPresenceInLadn(const std::shared_ptr<PresenceState>& value)
{
...
void SmContextCreateData::setUeLocation(const std::shared_ptr<UserLocation>& value)
{
    m_UeLocation = value;
...
void SmContextCreateData::setAddUeLocation(const std::shared_ptr<UserLocation>& value)
{
...
void SmContextCreateData::setSmContextStatusUri(const utility::string_t& value)
{
...
void SmContextCreateData::setAdditionalHsmfUri(const std::vector<utility::string_t>& value)
{
...
void SmContextCreateData::setPduSessionsActivateList(std::vector<int32_t> value)
{
...
void SmContextCreateData::setUeEpsPdnConnection(const utility::string_t& value)
{
...
void SmContextCreateData::setSelMode(const std::shared_ptr<DnnSelectionMode>& value)
{
    m_SelMode = value;
    m_SelModeIsSet = true;
}
...
std::vector<std::shared_ptr<BackupAmfInfo>>& SmContextCreateData::getBackupAmfInfo()
{
    return m_BackupAmfInfo;
}

void SmContextCreateData::setBackupAmfInfo(const std::vector<std::shared_ptr<BackupAmfInfo>>& value)
{
...
void SmContextCreateData::setTraceData(const std::shared_ptr<TraceData>& value)
{
    m_TraceData = value;
...
std::shared_ptr<EpsInterworkingIndication> SmContextCreateData::getEpsInterworkingInd() const
{
    return m_EpsInterworkingInd;
}

void SmContextCreateData::setEpsInterworkingInd(const std::shared_ptr<EpsInterworkingIndication>& value)
{
...
void SmContextCreateData::setTargetId(const std::shared_ptr<NgRanTargetId>& value)
{
    m_TargetId = value;
...
void SmContextCreateData::setEpsBearerCtxStatus(const utility::string_t& value)
{
...
void SmContextCreateData::setN2SmInfo(const std::shared_ptr<RefToBinaryData>& value)
{
    m_N2SmInfo = value;
