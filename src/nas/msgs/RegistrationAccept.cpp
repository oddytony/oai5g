...
//------------------------------------------------------------------------------
void RegistrationAccept::set_5GS_Registration_Result(bool emergency, bool nssaa,
                                                     bool sms, uint8_t value) {
  ie_5gs_registration_result = new _5GS_Registration_Result(0x00, emergency,
                                                            nssaa, sms, value);
}

//------------------------------------------------------------------------------
void RegistrationAccept::setSUCI_SUPI_format_IMSI(const string mcc,
                                                  const string mnc,
  ...
  if (protection_sch_id != NULL_SCHEME) {
    ...
    ie_5g_guti = new _5GSMobilityIdentity(mcc, mnc, routingInd,
...
//------------------------------------------------------------------------------
void RegistrationAccept::set5G_GUTI(const string mcc, const string mnc,
                                    const string amfRegionId,
                                    const string amfSetId,
                                    const string amfPointer,
                                    const uint32_t tmsi) {
  ...
  ie_5g_guti->set5GGUTI(mcc, mnc, (uint8_t) regionId, (uint16_t) setId,
                        (uint8_t) pointer, tmsi);
  ie_5g_guti->setIEI(0x77);
}
...
//------------------------------------------------------------------------------
void RegistrationAccept::setEquivalent_PLMNs(uint8_t MNC_MCC1, uint8_t MNC_MCC2,
                                             uint8_t MNC_MCC3) {
...
//------------------------------------------------------------------------------
void RegistrationAccept::setSOR_Transparent_Container(uint8_t header,
                                                      uint8_t *value) {
...
//------------------------------------------------------------------------------
void RegistrationAccept::setExtended_DRX_Parameters(uint8_t paging_time,
                                                    uint8_t value) {
  ie_extended_drx_parameters = new Extended_DRX_Parameters(0x6E, paging_time,
                                                           value);
}
...
int RegistrationAccept::encode2buffer(uint8_t *buf, int len) {
  ...
  if (!ie_5g_guti) {
    ...
    int size = ie_5g_guti->encode2buffer(buf + encoded_size,
                                         len - encoded_size);
    if (size) {
      encoded_size += size;
    } else {
  ...
  if (!ie_tai_list) {
    ...
    int size = ie_tai_list->encode2buffer(buf + encoded_size,
                                          len - encoded_size);
    if (size != -1) {
      encoded_size += size;
    } else {
  ...
  if (!ie_equivalent_plmns) {
    ...
    if (int size = ie_equivalent_plmns->encode2buffer(buf + encoded_size,
                                                      len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_allowed_nssai) {
    ...
    if (int size = ie_allowed_nssai->encode2buffer(buf + encoded_size,
                                                   len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_configured_nssai) {
    ...
    if (int size = ie_configured_nssai->encode2buffer(buf + encoded_size,
                                                      len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_T3512_value) {
    ...
    if (int size = ie_T3512_value->encode2buffer(buf + encoded_size,
                                                 len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_nssai_inclusion_mode) {
    ...
    if (int size = ie_nssai_inclusion_mode->encode2buffer(buf + encoded_size,
                                                          len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_non_3gpp_nw_policies) {
    ...
    if (int size = ie_non_3gpp_nw_policies->encode2buffer(buf + encoded_size,
                                                          len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_T3447_value) {
    ...
    if (int size = ie_T3447_value->encode2buffer(buf + encoded_size,
                                                 len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_T3448_value) {
    ...
    if (int size = ie_T3448_value->encode2buffer(buf + encoded_size,
                                                 len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_T3324_value) {
    ...
    if (int size = ie_T3324_value->encode2buffer(buf + encoded_size,
                                                 len - encoded_size)) {
      encoded_size += size;
    } else {
  ...
  if (!ie_pending_nssai) {
    ...
    if (int size = ie_pending_nssai->encode2buffer(buf + encoded_size,
                                                   len - encoded_size)) {
      encoded_size += size;
    } else {
...
#endif
  Logger::nas_mm().debug("Encoded RegistrationAccept message len (%d)",
                         encoded_size);
  return encoded_size;
}

//------------------------------------------------------------------------------
int RegistrationAccept::decodefrombuffer(NasMmPlainHeader *header, uint8_t *buf,
                                         int len) {
  ...
  while ((octet != 0x0)) {
    ...
    switch (octet) {
      case 0x77: {
        ...
        ie_5g_guti = new _5GSMobilityIdentity();
        decoded_size += ie_5g_guti->decodefrombuffer(buf + decoded_size,
      ...
      case 0x15: {
        ...
        decoded_size += ie_allowed_nssai->decodefrombuffer(buf + decoded_size,
                                                           len - decoded_size,
                                                           true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
      ...
      case 0x72: {
        ...
        decoded_size += ie_pdu_session_reactivation_result_error_cause
            ->decodefrombuffer(buf + decoded_size, len - decoded_size, true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
      }
        break;
      case 0x5E: {
        ...
        decoded_size += ie_T3512_value->decodefrombuffer(buf + decoded_size,
                                                         len - decoded_size,
                                                         true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
      ...
      case 0x5D: {
        ...
        decoded_size += ie_Non_3GPP_de_registration_timer_value
            ->decodefrombuffer(buf + decoded_size, len - decoded_size, true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
      }
      ...
      case 0x6C: {
        ...
        decoded_size += ie_T3447_value->decodefrombuffer(buf + decoded_size,
                                                         len - decoded_size,
                                                         true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
      ...
      case 0x6B: {
        ...
        decoded_size += ie_T3448_value->decodefrombuffer(buf + decoded_size,
                                                         len - decoded_size,
                                                         true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
      ...
      case 0x6A: {
        ...
        decoded_size += ie_T3324_value->decodefrombuffer(buf + decoded_size,
                                                         len - decoded_size,
                                                         true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
      ...
      case 0x39: {
        ...
        decoded_size += ie_pending_nssai->decodefrombuffer(buf + decoded_size,
                                                           len - decoded_size,
                                                           true);
        octet = *(buf + decoded_size);
        Logger::nas_mm().debug("Next IEI (0x%x)", octet);
  ...
  Logger::nas_mm().debug("Decoded RegistrationAccept message len (%d)",
                         decoded_size);
