...
//------------------------------------------------------------------------------
bool PDUSessionResourceSetupListSUReq::decodefromPDUSessionResourceSetupListSUReq(
    Ngap_PDUSessionResourceSetupListSUReq_t *pduSessionResourceSetupListSUReq) {
  numofpduSessionResourceSetupItemSUReq = pduSessionResourceSetupListSUReq->list
      .count;
  pduSessionResourceSetupItemSUReq =
      new PDUSessionResourceSetupItemSUReq[numofpduSessionResourceSetupItemSUReq]();
  for (int i = 0; i < numofpduSessionResourceSetupItemSUReq; i++) {
    if (!pduSessionResourceSetupItemSUReq[i]
