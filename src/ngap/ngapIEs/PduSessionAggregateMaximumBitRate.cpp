...
//------------------------------------------------------------------------------
bool PduSessionAggregateMaximumBitRate::encode2PduSessionAggregateMaximumBitRate(
  ...
  pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateDL.buf =
      (uint8_t*) calloc(
          1,
  ...
  for (int i = 0;
      i < pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateDL.size;
      i++) {
    pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateDL.buf[i] =
        (aggregatemaxbitratedl & (0xff0000000000 >> i * 8))
            >> ((pdusessionAggregateMaxBitRate
                .pDUSessionAggregateMaximumBitRateDL.size - i - 1) * 8);
  }

  pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateUL.size = 6;
  pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateUL.buf =
      (uint8_t*) calloc(
          1,
  ...
  for (int i = 0;
      i < pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateUL.size;
      i++) {
    pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateUL.buf[i] =
        (aggregatemaxbitrateul & (0xff0000000000 >> i * 8))
            >> ((pdusessionAggregateMaxBitRate
                .pDUSessionAggregateMaximumBitRateUL.size - i - 1) * 8);
  }
...
//------------------------------------------------------------------------------
bool PduSessionAggregateMaximumBitRate::decodefromPduSessionAggregateMaximumBitRate(
    Ngap_PDUSessionAggregateMaximumBitRate_t &pdusessionAggregateMaxBitRate) {
  if (!pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateDL.buf)
    return false;
  if (!pdusessionAggregateMaxBitRate.pDUSessionAggregateMaximumBitRateUL.buf)
