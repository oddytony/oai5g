...
//------------------------------------------------------------------------------
bool PDUSessionResourceSetupItemSUReq::decodefromPDUSessionResourceSetupItemSUReq(
    Ngap_PDUSessionResourceSetupItemSUReq_t *pduSessionResourceSetupItemSUReq) {
  ...
  pDUSessionResourceSetupRequestTransfer = pduSessionResourceSetupItemSUReq
      ->pDUSessionResourceSetupRequestTransfer;
