...
//------------------------------------------------------------------------------
void UEAggregateMaxBitRate::setUEAggregateMaxBitRate(long bit_rate_downlink,
...
//------------------------------------------------------------------------------
bool UEAggregateMaxBitRate::getUEAggregateMaxBitRate(long &bit_rate_downlink,
                                                     long &bit_rate_uplink) {
...
bool UEAggregateMaxBitRate::encode2UEAggregateMaxBitRate(
  ...
  if (!ueAggregateMaxBitRate.uEAggregateMaximumBitRateDL.buf)
    return false;
  ...
  for (int i = 0; i < ueAggregateMaxBitRate.uEAggregateMaximumBitRateDL.size;
    ...
    ueAggregateMaxBitRate.uEAggregateMaximumBitRateDL.buf[i] =
        (ueaggregatemaxbitratedl & (0xff000000 >> i * 8))
            >> ((ueAggregateMaxBitRate.uEAggregateMaximumBitRateDL.size - i - 1)
                * 8);
  }
  ...
  if (!ueAggregateMaxBitRate.uEAggregateMaximumBitRateUL.buf)
    return false;
  ...
  for (int i = 0; i < ueAggregateMaxBitRate.uEAggregateMaximumBitRateUL.size;
    ...
    ueAggregateMaxBitRate.uEAggregateMaximumBitRateUL.buf[i] =
        (ueaggregatemaxbitrateul & (0xff000000 >> i * 8))
            >> ((ueAggregateMaxBitRate.uEAggregateMaximumBitRateUL.size - i - 1)
                * 8);
  }
...
bool UEAggregateMaxBitRate::decodefromUEAggregateMaxBitRate(
  ...
  for (int i = 0; i < ueAggregateMaxBitRate.uEAggregateMaximumBitRateDL.size;
    ...
    ueaggregatemaxbitratedl |= ueAggregateMaxBitRate.uEAggregateMaximumBitRateDL
        .buf[i];
  }
  for (int i = 0; i < ueAggregateMaxBitRate.uEAggregateMaximumBitRateUL.size;
      i++) {
    ueaggregatemaxbitrateul = ueaggregatemaxbitrateul << 8;
    ueaggregatemaxbitrateul |= ueAggregateMaxBitRate.uEAggregateMaximumBitRateUL
        .buf[i];
  }
