...
void PduSessionResourceSetupResponseMsg::setMessageType() {
  if (!pduSessionResourceSetupResponsePdu)
    pduSessionResourceSetupResponsePdu = (Ngap_NGAP_PDU_t*) calloc(1, sizeof(Ngap_NGAP_PDU_t));

  MessageType pduSessionResourceSetupResponsePduTypeIE;
  pduSessionResourceSetupResponsePduTypeIE.setProcedureCode(Ngap_ProcedureCode_id_PDUSessionResourceSetup);
  pduSessionResourceSetupResponsePduTypeIE.setTypeOfMessage(Ngap_NGAP_PDU_PR_successfulOutcome);
  pduSessionResourceSetupResponsePduTypeIE.setCriticality(Ngap_Criticality_reject);
  pduSessionResourceSetupResponsePduTypeIE.setValuePresent(Ngap_SuccessfulOutcome__value_PR_PDUSessionResourceSetupResponse);

  if (pduSessionResourceSetupResponsePduTypeIE.getProcedureCode() == Ngap_ProcedureCode_id_PDUSessionResourceSetup && pduSessionResourceSetupResponsePduTypeIE.getTypeOfMessage() == Ngap_NGAP_PDU_PR_successfulOutcome
      && pduSessionResourceSetupResponsePduTypeIE.getCriticality() == Ngap_Criticality_reject) {
    pduSessionResourceSetupResponsePduTypeIE.encode2pdu(pduSessionResourceSetupResponsePdu);
...
void PduSessionResourceSetupResponseMsg::setAmfUeNgapId(unsigned long id) {
  ...
  Ngap_PDUSessionResourceSetupResponseIEs_t *ie = (Ngap_PDUSessionResourceSetupResponseIEs_t*) calloc(1, sizeof(Ngap_PDUSessionResourceSetupResponseIEs_t));
  ...
  ret = ASN_SEQUENCE_ADD(&pduSessionResourceSetupResponseIEs->protocolIEs.list, ie);
  if (ret != 0)
    cout << "encode AMF_UE_NGAP_ID IE error" << endl;
}

//------------------------------------------------------------------------------
void PduSessionResourceSetupResponseMsg::setRanUeNgapId(uint32_t ran_ue_ngap_id) {
  if (!ranUeNgapId)
...
//------------------------------------------------------------------------------
void PduSessionResourceSetupResponseMsg::setPduSessionResourceSetupResponseList(std::vector<PDUSessionResourceSetupResponseItem_t> list) {
  if (!pduSessionResourceSetupResponseList)
    pduSessionResourceSetupResponseList = new PDUSessionResourceSetupListSURes();

  PDUSessionResourceSetupItemSURes *m_pduSessionResourceSetupItemSURes = new PDUSessionResourceSetupItemSURes[list.size()]();

  for (int i = 0; i < list.size(); i++) {
    PDUSessionID *m_pDUSessionID = new PDUSessionID();
    m_pDUSessionID->setPDUSessionID(list[i].pduSessionId);

    m_pduSessionResourceSetupItemSURes[i].setPDUSessionResourceSetupItemSURes(m_pDUSessionID, list[i].pduSessionResourceSetupResponseTransfer);
  }

  pduSessionResourceSetupResponseList->setPDUSessionResourceSetupListSURes(m_pduSessionResourceSetupItemSURes, list.size());
  ...
  int ret = pduSessionResourceSetupResponseList->encode2PDUSessionResourceSetupListSURes(&ie->value.choice.PDUSessionResourceSetupListSURes);
  if (!ret) {
...
//------------------------------------------------------------------------------
void PduSessionResourceSetupResponseMsg::setPduSessionResourceFailedToSetupList(std::vector<PDUSessionResourceFailedToSetupItem_t> list) {
  ...
  PDUSessionResourceFailedToSetupItemSURes *m_pduSessionResourceFailedToSetupItemSURes = new PDUSessionResourceFailedToSetupItemSURes[list.size()]();

  for (int i = 0; i < list.size(); i++) {
    PDUSessionID *m_pDUSessionID = new PDUSessionID();
    m_pDUSessionID->setPDUSessionID(list[i].pduSessionId);

    m_pduSessionResourceFailedToSetupItemSURes[i].setPDUSessionResourceFailedToSetupItemSURes(m_pDUSessionID, list[i].pduSessionResourceSetupUnsuccessfulTransfer);
  }

  pduSessionResourceFailedToSetupResponseList->setPDUSessionResourceFailedToSetupListSURes(m_pduSessionResourceFailedToSetupItemSURes, list.size());
  ...
  int ret = pduSessionResourceFailedToSetupResponseList->encode2PDUSessionResourceFailedToSetupListSURes(&ie->value.choice.PDUSessionResourceFailedToSetupListSURes);
  if (!ret) {
...
//------------------------------------------------------------------------------
int PduSessionResourceSetupResponseMsg::encode2buffer(uint8_t *buf, int buf_size) {
  asn_fprint(stderr, &asn_DEF_Ngap_NGAP_PDU, pduSessionResourceSetupResponsePdu);
  asn_enc_rval_t er = aper_encode_to_buffer(&asn_DEF_Ngap_NGAP_PDU, NULL, pduSessionResourceSetupResponsePdu, buf, buf_size);
...
//------------------------------------------------------------------------------
//Decapsulation
bool PduSessionResourceSetupResponseMsg::decodefrompdu(Ngap_NGAP_PDU_t *ngap_msg_pdu) {
  ...
  if (pduSessionResourceSetupResponsePdu->present == Ngap_NGAP_PDU_PR_successfulOutcome) {
    if (pduSessionResourceSetupResponsePdu->choice.successfulOutcome && pduSessionResourceSetupResponsePdu->choice.successfulOutcome->procedureCode == Ngap_ProcedureCode_id_PDUSessionResourceSetup && pduSessionResourceSetupResponsePdu->choice.successfulOutcome->criticality == Ngap_Criticality_reject
        && pduSessionResourceSetupResponsePdu->choice.successfulOutcome->value.present == Ngap_SuccessfulOutcome__value_PR_PDUSessionResourceSetupResponse) {
      pduSessionResourceSetupResponseIEs = &pduSessionResourceSetupResponsePdu->choice.successfulOutcome->value.choice.PDUSessionResourceSetupResponse;
    } else {
...
//------------------------------------------------------------------------------
bool PduSessionResourceSetupResponseMsg::getPduSessionResourceSetupResponseList(std::vector<PDUSessionResourceSetupResponseItem_t> &list) {
  if (!pduSessionResourceSetupResponseList)
    return false;
...
//------------------------------------------------------------------------------
bool PduSessionResourceSetupResponseMsg::getPduSessionResourceFailedToSetupList(std::vector<PDUSessionResourceFailedToSetupItem_t> &list) {
  if (!pduSessionResourceFailedToSetupResponseList)
    return false;

  PDUSessionResourceFailedToSetupItemSURes *m_pduSessionResourceFailedToSetupItemSURes;
  int num = 0;
  pduSessionResourceFailedToSetupResponseList->getPDUSessionResourceFailedToSetupListSURes(m_pduSessionResourceFailedToSetupItemSURes, num);

  for (int i = 0; i < num; i++) {
    PDUSessionResourceFailedToSetupItem_t failedToResponse;

    PDUSessionID *m_pDUSessionID;
    m_pduSessionResourceFailedToSetupItemSURes[i].getPDUSessionResourceFailedToSetupItemSURes(m_pDUSessionID, failedToResponse.pduSessionResourceSetupUnsuccessfulTransfer);
