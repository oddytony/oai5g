...
class InitialContextSetupRequestMsg {
 public:
  ...
  void setCoreNetworkAssistanceInfo(uint16_t ueIdentityIndexValue/*10bits*/,
                                    e_Ngap_PagingDRX ueSpecificDrx,
                                    uint8_t periodicRegUpdateTimer,
                                    bool micoModeInd,
  ...
  void setUESecurityCapability(uint16_t NR_EncryptionAlgs,
  ...
  bool getCoreNetworkAssistanceInfo(uint16_t &ueIdentityIndexValue/*10bits*/,
                                    int &ueSpecificDrx,
                                    uint8_t &periodicRegUpdateTimer,
                                    bool &micoModeInd,
                                    std::vector<Tai_t> &taiListForRRcInactive);
  ...
  bool getUESecurityCapability(uint16_t &NR_EncryptionAlgs,
                               uint16_t &NR_IntegrityProtectionAlgs,
                               uint16_t &E_UTRA_EncryptionAlgs,
                               uint16_t &E_UTRA_IntegrityProtectionAlgs);
